/**
 * SVGIconProvider - Material Design SVG icon provider
 * Uses react-native-svg when available, matching the web preview's icon set.
 * @module schema/icons/SVGIconProvider
 */

import React from 'react';

/** Icon provider interface (duplicated to avoid circular dependency with IconRegistry) */
interface IconProvider {
  name: string;
  resolve(iconName: string, size: number, color: string): React.ReactElement | null;
}

/** Material Design SVG path data (same paths used by the web preview) */
const ICON_PATHS: Record<string, string> = {
  ...
  wifi: 'M1 9l2 2a12.73 12.73 0 0118 0l2-2A15.57 15.57 0 001 9zm8 8l3 3 3-3a4.24 4.24 0 00-6 0zm-4-4l2 2a8.48 8.48 0 0110 0l2-2A11.36 11.36 0 005 13z',
  ...
  headset: 'M12 1a9 9 0 00-9 9v7c0 1.66 1.34 3 3 3h3v-8H5v-2c0-3.87 3.13-7 7-7s7 3.13 7 7v2h-4v8h3c1.66 0 3-1.34 3-3v-7a9 9 0 00-9-9z',
  email: 'M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z',
  mail: 'M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z',
  history: 'M13 3a9 9 0 00-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7a6.97 6.97 0 01-4.95-2.05l-1.41 1.41A8.96 8.96 0 0013 21a9 9 0 000-18zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z',
  ...
  'live_help': 'M19 2H5a2 2 0 00-2 2v14a2 2 0 002 2h4l3 3 3-3h4c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-6 16h-2v-2h2v2zm2.07-7.75l-.9.92C13.45 11.9 13 12.5 13 14h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-.9-2-2-2s-2 .9-2 2H8c0-2.21 1.79-4 4-4s4 1.79 4 4c0 .88-.36 1.68-.93 2.25z',
  'sim_card': 'M19.99 4c0-1.1-.89-2-1.99-2h-8L4 8v12c0 1.1.9 2 2 2h12.01c1.1 0 1.99-.9 1.99-2l-.01-16zM9 19H7v-2h2v2zm8 0h-2v-2h2v2zm-8-4H7v-4h2v4zm4 4h-2v-4h2v4zm0-6h-2v-2h2v2zm4 2h-2v-4h2v4z',
  ...
  // Lucide / Feather aliases — map common Lucide icon names to Material Design paths
  'bar-chart': 'M5 9.2h3V19H5V9.2zM10.6 5h2.8v14h-2.8V5zm5.6 8H19v6h-2.8v-6z',
  'bar-chart-2': 'M5 9.2h3V19H5V9.2zM10.6 5h2.8v14h-2.8V5zm5.6 8H19v6h-2.8v-6z',
  ...
  grid_view: 'M4 8h4V4H4v4zm6 12h4v-4h-4v4zm-6 0h4v-4H4v4zm0-6h4v-4H4v4zm6 0h4v-4h-4v4zm6-10v4h4V4h-4zm-6 4h4V4h-4v4zm6 6h4v-4h-4v4zm0 6h4v-4h-4v4z',
  ...
  // Additional aliases and icons (synced with web preview)
  ...
  'file-text': 'M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zM6 20V4h7v5h5v11H6zm2-6h8v2H8v-2zm0-3h8v2H8v-2z',
  'help-circle': 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm2.07-7.75l-.9.92C13.45 12.9 13 13.5 13 15h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-.9-2-2-2s-2 .9-2 2H8c0-2.21 1.79-4 4-4s4 1.79 4 4c0 .88-.36 1.68-.93 2.25z',
  'message-square': 'M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z',
  message_square: 'M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z',
  'trending-up': 'M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6h-6z',
  layers: 'M11.99 18.54l-7.37-5.73L3 14.07l9 7 9-7-1.63-1.27zM12 16l7.36-5.73L21 9l-9-7-9 7 1.63 1.27z',
  'refresh-cw': 'M23.65 10.34C22.68 5.62 18.44 2.2 13.47 2.2c-3.27 0-6.18 1.55-8.03 3.96L3.44 4.16v6h6l-2.6-2.6c1.37-1.78 3.51-2.93 5.93-2.93 3.96 0 7.17 3.17 7.26 7.11l2.62.6zm-1.3 3.32l-6 .01 2.6 2.6c-1.37 1.78-3.51 2.93-5.93 2.93-3.96 0-7.17-3.17-7.26-7.11l-2.62-.6C4 16.38 8.24 19.8 13.21 19.8c3.27 0 6.18-1.55 8.03-3.96l2 2v-6h-.89z',
...
// Lazily resolved react-native-svg components
let SvgComponent: React.ComponentType<Record<string, unknown>> | null = null;
let PathComponent: React.ComponentType<Record<string, unknown>> | null = null;
let svgResolved = false;

function resolveSvg(): boolean {
  if (svgResolved) return SvgComponent !== null;
  svgResolved = true;
  try {
    // Dynamic require — only works if react-native-svg is installed
    // eslint-disable-next-line @typescript-eslint/no-var-requires
    const rnSvg = require('react-native-svg');
    SvgComponent = rnSvg.Svg ?? rnSvg.default;
    PathComponent = rnSvg.Path;
    return SvgComponent !== null && PathComponent !== null;
  } catch {
    return false;
  }
}

/** Material Design SVG icon provider — requires react-native-svg */
export class SVGIconProvider implements IconProvider {
  name = 'material-svg';

  resolve(iconName: string, size: number, color: string): React.ReactElement | null {
    // Look up path data (try exact, then dash→underscore, then underscore→dash)
    const path =
      ICON_PATHS[iconName] ??
      ICON_PATHS[iconName.replace(/-/g, '_')] ??
      ICON_PATHS[iconName.replace(/_/g, '-')];

    if (!path) return null;
    if (!resolveSvg() || !SvgComponent || !PathComponent) return null;

    return React.createElement(
      SvgComponent,
      { width: size, height: size, viewBox: '0 0 24 24' },
      React.createElement(PathComponent, { d: path, fill: color }),
    );
  }
}

/** Get the available icon names from the SVG icon set */
